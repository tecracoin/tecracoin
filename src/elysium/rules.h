#ifndef TECRACOIN_ELYSIUM_RULES_H
#define TECRACOIN_ELYSIUM_RULES_H
...
public:
    ...
    /**
     * Amount of TCR to pay when create a new property on main ecosystem.
     **/
...
#endif // TECRACOIN_ELYSIUM_RULES_H
