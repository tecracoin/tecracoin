...
std::string elysium::strMPProperty(uint32_t propertyId)
{
    ...
    if (0x80000000 & propertyId) {
        ...
        switch (propertyId) {
            case ELYSIUM_PROPERTY_TCR: str = "TCR";
                break;
...
{
    if ((ELYSIUM_PROPERTY_TCR != propertyId) && !isTestEcosystemProperty(propertyId)) return true;
...
int input_mp_offers_string(const std::string& s)
{
    ...
    if (ELYSIUM_PROPERTY_TCR != prop_desired) return -1;
