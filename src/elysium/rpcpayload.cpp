...
UniValue elysium_createpayload_dexsell(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 6)
        throw runtime_error(
            ...
            "\nCreate a payload to place, update or cancel a sell offer on the traditional distributed ELYSIUM/TCR exchange.\n"
    ...
    if (action <= CMPTransaction::UPDATE) { // actions 3 permit zero values, skip check
        ...
        amountDesired = ParseAmount(request.params[2], true); // TCR is divisible
...
UniValue elysium_createpayload_issuancefixed(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 9)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_createpayload_issuancefixed", "2 1 0 \"Companies\" \"TecraCoin Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
            + HelpExampleRpc("elysium_createpayload_issuancefixed", "2, 1, 0, \"Companies\", \"TecraCoin Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
        );
...
UniValue elysium_createpayload_issuancecrowdsale(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 13)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_createpayload_issuancecrowdsale", "2 1 0 \"Companies\" \"TecraCoin Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
            + HelpExampleRpc("elysium_createpayload_issuancecrowdsale", "2, 1, 0, \"Companies\", \"TecraCoin Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
        );
...
UniValue elysium_createpayload_issuancemanaged(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 8)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_createpayload_issuancemanaged", "2 1 0 \"Companies\" \"TecraCoin Mining\" \"Quantum Miner\" \"\" \"\"")
            + HelpExampleRpc("elysium_createpayload_issuancemanaged", "2, 1, 0, \"Companies\", \"TecraCoin Mining\", \"Quantum Miner\", \"\", \"\"")
        );
