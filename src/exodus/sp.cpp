...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_exodus.url = "https://www.tecracoin.io";
    implied_exodus.data = "Exodus serve as the binding between TecraCoin, smart properties and contracts created on the Exodus Layer.";
    ...
    implied_texodus.url = "https://www.tecracoin.io";
    implied_texodus.data = "Test Exodus serve as the binding between TecraCoin, smart properties and contracts created on the Exodus Layer.";
