...
{
    {
        ...
        txInputs.push_back(createTxOut(5000000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));
        ...
        BOOST_CHECK_EQUAL(metaTx.getSender(), "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb");
    ...
    }
    {
        ...
        std::vector<CTxOut> txInputs;
        txInputs.push_back(createTxOut(6000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));

        std::vector<CTxOut> txOutputs;
        txOutputs.push_back(OpReturn_SimpleSend());
        txOutputs.push_back(createTxOut(6000, "TDp5J8BB6kFnPBYaWZQTpNoP1Nnvqms5Zi"));
        ...
        BOOST_CHECK_EQUAL(metaTx.getSender(), "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb");
        BOOST_CHECK_EQUAL(metaTx.getReceiver(), "TDp5J8BB6kFnPBYaWZQTpNoP1Nnvqms5Zi");
        BOOST_CHECK_EQUAL(metaTx.getPayload(), "00000000000000070000000006dac2c0");
    }
    {
        ...
        std::vector<CTxOut> txInputs;
        txInputs.push_back(createTxOut(80000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));

        std::vector<CTxOut> txOutputs;
        txOutputs.push_back(OpReturn_SimpleSend());
        txOutputs.push_back(createTxOut(6000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));
        ...
        BOOST_CHECK_EQUAL(metaTx.getSender(), "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb");
        BOOST_CHECK_EQUAL(metaTx.getReceiver(), "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb");
        BOOST_CHECK_EQUAL(metaTx.getPayload(), "00000000000000070000000006dac2c0");
    }
    {
        int nBlock = std::numeric_limits<int>::max();
        ...
        std::vector<CTxOut> txOutputs;
        txOutputs.push_back(OpReturn_SimpleSend());
        txOutputs.push_back(createTxOut(6000, "TKPLQbabTtreZzLnDiyQHta5YstSnor7re"));
        txOutputs.push_back(PayToPubKey_Unrelated());
        txOutputs.push_back(NonStandardOutput());
        txOutputs.push_back(createTxOut(6000, "TJunnckJgTRK54ggHcvEwfvoLT4ZaiVbUy"));
        ...
        BOOST_CHECK(ParseTransaction(dummyTx, nBlock, 1, metaTx) == 0);
        BOOST_CHECK_EQUAL(metaTx.getSender(), "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb");
        BOOST_CHECK_EQUAL(metaTx.getReceiver(), "TJunnckJgTRK54ggHcvEwfvoLT4ZaiVbUy");
    }
    {
        int nBlock = std::numeric_limits<int>::max();

        std::vector<CTxOut> txInputs;
        txInputs.push_back(createTxOut(55550, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));
...
{
    {
        ...
        std::vector<CTxOut> txInputs;
        txInputs.push_back(createTxOut(900000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));
        ...
        BOOST_CHECK_EQUAL(metaTx.getReceiver(), "TA8nRoksTPKqkpZbh3rscw3zrbiXhEEM6u");
    }
}
...
{
    {
        ...
        std::vector<CTxOut> txInputs;
        txInputs.push_back(createTxOut(100000, "TJXXX1K63dYkZtdknJxBuLoRWvj8Y8rnsb"));
