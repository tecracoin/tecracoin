...
BOOST_AUTO_TEST_CASE(txbuilder_add_change)
{
    std::string rawTx("0100000002605842f019601de54248b9fb4a32b498a7762c6513213b39041fbd89890e3a010200000000"
        ...
        "08000000001976a9144cf0fef9d9e4eda843a317a1be9f3ca4e3fdeb9388ac5622b701000000001976a9145a7165c0337b"
        "595c570a207bb4ff6f897c922ef988ac00000000");
    ...
    CBitcoinAddress addrA("TGz34LJxQy11ga8tKpfkfxaLGqAgjt8CqZ");
    CBitcoinAddress addrB("TJDRfKNsnbnsvnZa6AaPZjQHxYXUjC5f7j");
...
BOOST_AUTO_TEST_CASE(txbuilder_add_change_position)
{
    ...
    std::string rawTx("0100000001e83e80ce7b1c618bb21acc4ffdf1f420998a2dea7f6f974edae7e5f3dd28be440100000000"
        ...
        "a9144cf0fef9d9e4eda843a317a1be9f3ca4e3fdeb9388ac80778e06000000001976a914c656177b31a1cf5f9f319ce67c"
    ...
    CBitcoinAddress addr("TGz34LJxQy11ga8tKpfkfxaLGqAgjt8CqZ");
...
BOOST_AUTO_TEST_CASE(exodustxbuilder_op_return)
{
    ...
    std::string rawTx("01000000021dc7f242305900960a80cadd2a5d06d2cbbc4bbdd029db37c56a975487b8d4b20100000000"
        ...
        "0000000000186a1665786f6475730000000000000001000000009502f9006449f605000000001976a9145a7165c0337b59"
        "5c570a207bb4ff6f897c922ef988acaa0a0000000000001976a9144cf0fef9d9e4eda843a317a1be9f3ca4e3fdeb9388ac"
        "00000000");
    ...
    tx = ExodusTxBuilder(tx)
        .addOpReturn(payload)
        .addReference("TGz34LJxQy11ga8tKpfkfxaLGqAgjt8CqZ", 2730LL)
        .addChange("TJDRfKNsnbnsvnZa6AaPZjQHxYXUjC5f7j", viewTemp, 10000LL, 1)
        .build();
