...
BOOST_AUTO_TEST_CASE(valid_common_class_b)
{
    ...
    txInputs.push_back(createTxOut(1000000, "T9yWfbrsccwVRCgFdw7qptDu6Un2cnburp"));
    txInputs.push_back(createTxOut(1000000, "TYqpiHWtTS2QyezqPQvAjiRGmxDNz2E3Gm"));
    txInputs.push_back(createTxOut(2000001, "TJLDyw59UfcKVih3182vktgVKaRNgdkewS"));
    ...
    BOOST_CHECK_EQUAL(metaTx.getSender(), "TJLDyw59UfcKVih3182vktgVKaRNgdkewS");
...
BOOST_AUTO_TEST_CASE(valid_arbitrary_output_number_class_b)
{
    ...
    std::vector<CTxOut> txInputs;
    txInputs.push_back(createTxOut(5550000, "TJLDyw59UfcKVih3182vktgVKaRNgdkewS"));
